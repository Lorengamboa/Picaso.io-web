...
var CoreAdmin = /** @class */ (function (_super) {
        ...
        return (React.createElement(TranslationProvider, null,
            React.createElement(ConnectedRouter, { history: this.history },
                React.createElement(Switch, null,
                    loginPage !== false ? (React.createElement(Route, { exact: true, path: "/login", render: function (props) {
                            return createElement(loginPage, __assign({}, props, { title: title,
                                theme: theme }));
                        } })) : null,
                    React.createElement(Route, { path: "/", render: function (props) { return (React.createElement(CoreAdminRouter, __assign({ appLayout: appLayout, catchAll: catchAll, customRoutes: customRoutes, dashboard: dashboard, loading: loading, loginPage: loginPage, logout: logout, menu: menu, theme: theme, title: title }, props), children)); } })))));
    };
