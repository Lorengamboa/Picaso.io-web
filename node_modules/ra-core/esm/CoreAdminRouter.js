        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Switch, null,
                customRoutes
                    ...
                    .map(function (route, index) { return (React.createElement(Route, { key: index, exact: route.props.exact, path: route.props.path, render: function (props) {
                        return _this.renderCustomRoutesWithoutLayout(route, props);
                    } })); }),
                React.createElement(Route, { path: "/", render: function () {
                        return createElement(appLayout, {
                            children: (React.createElement(RoutesWithLayout, { catchAll: catchAll, children: childrenToRender, customRoutes: customRoutes.filter(function (route) { return !route.props.noLayout; }), dashboard: dashboard, title: title })),
                            dashboard: dashboard,
                            logout: logout,
                            menu: menu,
                            theme: theme,
