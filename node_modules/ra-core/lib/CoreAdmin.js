...
var createHashHistory_1 = __importDefault(require("history/createHashHistory"));
...
var CoreAdmin = /** @class */ (function (_super) {
    ...
    function CoreAdmin(props, context) {
        ...
        if (context.store) {
            ...
            _this.history = props.history || createHashHistory_1.default();
        }
        return _this;
    }
...
exports.default = withContext_1.default({
