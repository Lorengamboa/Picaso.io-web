...
var CoreAdminRouter = /** @class */ (function (_super) {
    ...
    function CoreAdminRouter() {
        ...
        _this.initializeResourcesAsync = function (props) { return __awaiter(_this, void 0, void 0, function () {
            var authProvider, permissions, children, childrenFuncResult, error_1;
            var _this = this;
        ...
        return (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement(react_router_dom_1.Switch, null,
                customRoutes
                    ...
                    .map(function (route, index) { return (react_1.default.createElement(react_router_dom_1.Route, { key: index, exact: route.props.exact, path: route.props.path, render: function (props) {
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: "/", render: function () {
                        return react_1.createElement(appLayout, {
                            children: (react_1.default.createElement(RoutesWithLayout_1.default, { catchAll: catchAll, children: childrenToRender, customRoutes: customRoutes.filter(function (route) { return !route.props.noLayout; }), dashboard: dashboard, title: title })),
                            dashboard: dashboard,
                            logout: logout,
                            menu: menu,
                            theme: theme,
...
CoreAdminRouter.propTypes = {
    ...
    isLoggedIn: prop_types_1.default.bool,
