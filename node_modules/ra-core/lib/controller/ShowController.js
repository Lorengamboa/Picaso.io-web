 ...
 *     export default App;
 */
var ShowController = /** @class */ (function (_super) {
    __extends(ShowController, _super);
    function ShowController() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShowController.prototype.componentDidMount = function () {
        this.updateData();
    };
    ShowController.prototype.componentWillReceiveProps = function (nextProps) {
        if (this.props.id !== nextProps.id ||
            nextProps.version !== this.props.version) {
            this.updateData(nextProps.resource, nextProps.id);
        }
    };
    ShowController.prototype.updateData = function (resource, id) {
    ...
    ShowController.prototype.render = function () {
        var _a = this.props, basePath = _a.basePath, children = _a.children, id = _a.id, isLoading = _a.isLoading, record = _a.record, resource = _a.resource, title = _a.title, translate = _a.translate, version = _a.version;
        if (!children)
            return null;
...
ShowController.propTypes = {
    ...
    crudGetOne: prop_types_1.default.func.isRequired,
    ...
    version: prop_types_1.default.number.isRequired,
};
...
exports.default = compose_1.default(checkMinimumRequiredProps_1.default('Show', [
    'basePath',
    'location',
    'resource',
]), react_redux_1.connect(mapStateToProps, { crudGetOne: actions_1.crudGetOne }), translate_1.default)(ShowController);
