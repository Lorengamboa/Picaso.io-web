...
var ReferenceManyFieldController = /** @class */ (function (_super) {
    ...
    ReferenceManyFieldController.prototype.fetchReferences = function (_a) {
        ...
        var relatedTo = oneToMany_1.nameRelatedTo(reference, record[source], resource, target, filter);
...
ReferenceManyFieldController.propTypes = {
    ...
    crudGetManyReference: prop_types_1.default.func.isRequired,
...
function mapStateToProps(state, props) {
    var relatedTo = oneToMany_1.nameRelatedTo(props.reference, props.record[props.source], props.resource, props.target, props.filter);
    return {
