 ...
 *     export default App;
 */
var CreateController = /** @class */ (function (_super) {
...
CreateController.propTypes = {
    ...
    crudCreate: prop_types_1.default.func.isRequired,
...
exports.default = compose_1.default(checkMinimumRequiredProps_1.default('Create', [
    'basePath',
    'location',
    'resource',
]), react_redux_1.connect(mapStateToProps, { crudCreate: actions_1.crudCreate }), translate_1.default)(CreateController);
